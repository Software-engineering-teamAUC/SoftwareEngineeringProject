    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WishList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent to_wishlist = new Intent(MyProfile.this, WishList.class);
                startActivity(to_wishlist);
            }
        });
        ...
        first_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MyProfile.this, "You can edit your firstname now", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        last_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MyProfile.this, "You can edit your lastname now", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        user_email_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MyProfile.this, "You can edit your email now", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        Birth_Date_Edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Get current date
                Toast.makeText(MyProfile.this, "You can edit your birthdate now", Toast.LENGTH_SHORT).show();
