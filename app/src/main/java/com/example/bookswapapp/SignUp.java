...
public class SignUp extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        {
            Toast.makeText(this, "Username can't have '_' character", Toast.LENGTH_SHORT).show();
            return;
        }
                                                        ...
                                                        .addOnCompleteListener(task2 -> {
                                                            if (task2.isSuccessful()) {
                                                                if (!task2.getResult().isEmpty()) {
                                                                    ...
                                                                    user.put("password", EncryptionUtil.encrypt(password));
